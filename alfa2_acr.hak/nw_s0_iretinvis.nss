...
void main()
{
    ...
    float fDuration = RoundsToSeconds(1);    // JLR-OEI 05/08/06: Adjusted duration: PKM-OEI 08.25.06 adjusted duration again. Zel 06/08/2012: Adjusted again. Canon wins over truthiness.
