// ga_last_name_append(string sTarget, string sText, int nStrRef)
/*
	Description:
	Appends sText and nStrRef to the end of sTarget's last name.
...
void main(string sTarget, string sText, int nStrRef)
{
	...
	string sLastName = GetLastName(oTarget) + sText + sStringRef;
