...
int nSpellID = 462;	// GetSpellId() will do the job for us, NOT

void RunHandImpact(object oTarget, object oCaster, int nMetaMagic)
{
	//SpawnScriptDebugger();
    ...
    if (nCasterRoll >= nTargetRoll)
    {
       	...
       	int nDam  = MaximizeOrEmpower(8, 1, nMetaMagic, 11);
      	...
      	DelayCommand(6.0f,RunHandImpact(oTarget,oCaster, nMetaMagic));
   	}
}
    ...
    */
    ...
    if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, OBJECT_SELF))
    {
        ...
        if(nResult  == 0)
        {
            ...
            RunHandImpact(oTarget,OBJECT_SELF, nMetaMagic);
        }
    }
}