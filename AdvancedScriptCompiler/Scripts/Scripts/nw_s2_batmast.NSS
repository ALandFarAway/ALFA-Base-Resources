...
void main()
{
    ...
    nBonus *= 2;
    //effect eDamRed = EffectDamageReduction(nBonus, DAMAGE_POWER_PLUS_FIVE);	// 3.0 DR rules
    effect eDamRed = EffectDamageReduction( nBonus, 0, 0, DR_TYPE_NONE );		// 3.5 DR approximation
