...
// End of Spell Cast Hook
    ...
    //doAura(ALIGNMENT_GOOD, VFX_HIT_SPELL_ABJURATION, VFX_DUR_PROTECTION_EVIL_MAJOR, DAMAGE_TYPE_NEGATIVE);	// NWN1 VFX
    doAura(ALIGNMENT_GOOD, VFX_DUR_SPELL_EVIL_AURA, VFX_NONE, DAMAGE_TYPE_NEGATIVE);		// NWN2 VFX
}