...
//        HandleSpell(SPELL_MONSTROUS_REGENERATION, 3);  // JLR - OEI 08/09/05 -- Spell Removed
//        HandleSpell(SPELL_MASS_HASTE, 5, 1);  // JLR - OEI 08/09/05 -- Spell Removed
        HandleSpell(SPELL_LESSER_SPELL_MANTLE, 9, 1);
        HandleSpell(SPELL_MESTILS_ACID_SHEATH, 0, 1);
        HandleSpell(SPELL_LESSER_GLOBE_OF_INVULNERABILITY, 7, 1);	// JLR - OEI 07/11/05 -- Name Changed
    ...
    if(nBuffType == 2 || nBuffType == 3) // long or all buffs
    {
        ...
        HandleSpell(SPELL_PROTECTION_FROM_ENERGY, 1);	// JLR - OEI 07/11/05 -- Name Changed
        HandleSpell(SPELL_MAGIC_CIRCLE_AGAINST_EVIL, 4, 1);
        HandleSpell(SPELL_MAGIC_VESTMENT);
        HandleSpell(SPELL_INVISIBILITY_PURGE);
        HandleSpell(SPELL_RESIST_ENERGY, 1);	// JLR - OEI 07/11/05 -- Name Changed
        ...
        HandleSpell(SPELL_BEARS_ENDURANCE);	// JLR - OEI 07/11/05 -- Name Changed
        ...
        HandleSpell(SPELL_GREATER_INVISIBILITY, 6);	// JLR - OEI 07/11/05 -- Name Changed
