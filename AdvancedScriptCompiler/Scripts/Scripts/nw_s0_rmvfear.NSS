...
//:://////////////////////////////////////////////
/*
    All non-enemies within a 10ft radius have their fear
...
//:: RPGplayer1 04/16/2008: Removes shaken effect from fear auras
        ...
        if(!GetIsEnemy(oTarget))
        {
            ...
            while(GetIsEffectValid(eFear))
            {
                if (GetEffectType(eFear) == EFFECT_TYPE_FRIGHTENED ||
                    GetEffectSpellId(eFear) == SPELLABILITY_AURA_FEAR ||
                    GetEffectSpellId(eFear) == SPELLABILITY_DRAGON_FEAR)
                {
