...
// End of Spell Cast Hook
    ...
    //effect eVis = EffectVisualEffect(VFX_HIT_SPELL_NECROMANCY);	// All visual effects for Doom are now handled in CreateDoomEffectsLink(); see nw_i0_spells.nss for more info
