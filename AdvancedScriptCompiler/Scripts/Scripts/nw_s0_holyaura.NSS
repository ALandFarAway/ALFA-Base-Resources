...
void main()
{
    ...
    */
    ...
    //doAura(ALIGNMENT_EVIL, VFX_HIT_SPELL_ABJURATION, VFX_DUR_PROTECTION_GOOD_MAJOR, DAMAGE_TYPE_DIVINE);	// NWN1 VFX
    doAura(ALIGNMENT_EVIL, VFX_DUR_SPELL_GOOD_AURA, VFX_NONE, DAMAGE_TYPE_DIVINE);	// NWN2 VFX
}