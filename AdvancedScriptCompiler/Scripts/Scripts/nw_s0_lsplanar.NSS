...
// End of Spell Cast Hook
    ...
    else
    {
        ...
        switch (nAlign)
        {
            ...
            case ALIGNMENT_EVIL:
                {
                    eSummon = EffectSummonCreature("c_summ_imp", VFX_FNF_SUMMON_GATE, fDelay);
                    //eGate = EffectVisualEffect(VFX_FNF_SUMMON_GATE);
                }
            break;
            case ALIGNMENT_GOOD:
                {
                    eSummon = EffectSummonCreature("c_celestialwolf", VFX_FNF_SUMMON_CELESTIAL, fDelay);
                    //eGate = EffectVisualEffect(219);
                }
            break;
            case ALIGNMENT_NEUTRAL:
                {
                    eSummon = EffectSummonCreature("c_firemephit", VFX_FNF_SUMMON_MONSTER_3);
